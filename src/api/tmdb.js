...
export const requests = {
    ...
    fetchMoviesByGenre: (genreId) => `${BASE_URL}/discover/movie?api_key=${API_KEY}&with_genres=${genreId}&sort_by=popularity.desc`,
    fetchTvByGenre: (genreId) => `${BASE_URL}/discover/tv?api_key=${API_KEY}&with_genres=${genreId}&sort_by=popularity.desc`,
    fetchMoviesByLanguage: (lang) => `${BASE_URL}/discover/movie?api_key=${API_KEY}&with_original_language=${lang}&sort_by=popularity.desc`,
    fetchTvByLanguage: (lang) => `${BASE_URL}/discover/tv?api_key=${API_KEY}&with_original_language=${lang}&sort_by=popularity.desc`,
